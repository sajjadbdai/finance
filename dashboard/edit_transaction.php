...
if(isset($_POST['do_save'])){
    ...
    elseif($type==='transfer'&&!$toAccId) { $error='Destination account required for transfer.'; }
        ...
        try {
            ...
            header('Location: /dashboard/transactions.php?msg=saved'); exit;
...
<title><?=$isEdit?'Edit':'Add'?> Transaction — Sajjad Finance</title>
<?php include 'css.php'; ?>
</head><body>
<?php include 'nav.php'; ?>
<div class="main">
<div class="topbar">
  <div class="tbar-title"><?=$isEdit?'Edit':'Add'?> Transaction</div>
  <a href="transactions.php" class="btn btn-ghost btn-sm">← Back</a>
</div>
