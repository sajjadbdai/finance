...
foreach ($accounts as $a) {
    ...
    if ($isLiability) { $liabilities[] = ['id'=>$a['id'],'name'=>$a['name'],'bhd'=>abs($bhd)]; $totalLiab += abs($bhd); }
    else              { $assets[]      = ['id'=>$a['id'],'name'=>$a['name'],'bhd'=>$bhd];       $totalAssets += $bhd; }
}
...
<div class="card" style="padding:0;overflow:hidden;margin-bottom:8px;">
  ...
  <div class="tbl-wrap"><table class="tbl" style="font-size:.85rem;">
    ...
    <?php foreach($assets as $a):?><tr><td><a href="account_detail.php?id=<?=$a['id']?>"><?=htmlspecialchars($a['name'])?></a></td><td style="text-align:right;" data-hide="true"><?=money($a['bhd'])?></td></tr><?php endforeach;?>
    <tr><td><a href="portfolio.php">Portfolio (at cost)</a></td><td style="text-align:right;" data-hide="true"><?=money($portfolioBHD)?></td></tr>
    <tr><td><a href="fixed_assets.php">Fixed Assets (at cost)</a></td><td style="text-align:right;" data-hide="true"><?=money($fixedBHD)?></td></tr>
    <tr style="font-weight:700;border-top:1px solid var(--s3);"><td><a href="accounts.php">Total Assets</a></td><td style="text-align:right;" data-hide="true">BD <?=money($totalAssets+$portfolioBHD+$fixedBHD)?></td></tr>
    <tr><th colspan="2" style="padding-top:14px;">Liabilities</th></tr>
    <?php foreach($liabilities as $l):?><tr><td><a href="account_detail.php?id=<?=$l['id']?>"><?=htmlspecialchars($l['name'])?></a></td><td style="text-align:right;" data-hide="true"><?=money($l['bhd'])?></td></tr><?php endforeach;?>
    <tr style="font-weight:700;border-top:1px solid var(--s3);"><td><a href="accounts.php">Total Liabilities</a></td><td style="text-align:right;" data-hide="true">BD <?=money($totalLiab)?></td></tr>
    <tr style="font-weight:700;border-top:2px solid var(--s3);"><td><a href="trial_balance.php">Equity (Net Worth)</a></td><td style="text-align:right;" data-hide="true">BD <?=money($netWorth)?></td></tr>
    <tr style="font-weight:700;"><td><a href="trial_balance.php">TOTAL (Liabilities + Equity)</a></td><td style="text-align:right;" data-hide="true">BD <?=money($totalLiab+$netWorth)?></td></tr>
  </table></div>
  ...
  <div style="padding:10px 18px;font-size:.78rem;color:var(--muted);border-top:1px solid var(--s3);">
    ...
    BD <?=money($portfolioMarketBHD)?>, an unrealized <?=$unrealizedGL>=0?'gain':'loss'?> of
    BD <?=money(abs($unrealizedGL))?> over the cost basis shown. See
...
<div class="card" style="padding:0;overflow:hidden;">
  ...
  <div class="tbl-wrap"><table class="tbl" style="font-size:.85rem;">
    ...
    <?php foreach($incomeByCat as $cat=>$v):?><tr><td><?=htmlspecialchars($cat)?></td><td style="text-align:right;color:var(--green);" data-hide="true">+<?=money($v)?></td></tr><?php endforeach;?>
    <tr style="font-weight:700;border-top:1px solid var(--s3);"><td>Total Income</td><td style="text-align:right;color:var(--green);" data-hide="true">BD <?=money($totalIncome)?></td></tr>
    <tr><th colspan="2" style="padding-top:14px;">Expense</th></tr>
    <?php foreach($expenseByCat as $cat=>$v):?><tr><td><?=htmlspecialchars($cat)?></td><td style="text-align:right;color:var(--red);" data-hide="true">-<?=money($v)?></td></tr><?php endforeach;?>
    <tr style="font-weight:700;border-top:1px solid var(--s3);"><td>Total Expense</td><td style="text-align:right;color:var(--red);" data-hide="true">BD <?=money($totalExpense)?></td></tr>
    <tr style="font-weight:700;border-top:2px solid var(--blue);"><td>Net Income</td><td style="text-align:right;" class="<?=$netIncome>=0?'c-green':'c-red'?>" data-hide="true">BD <?=money($netIncome)?></td></tr>
  </table></div>
  ...
  <div style="padding:12px 18px;font-size:.8rem;color:var(--muted);border-top:1px solid var(--s3);">
    ...
    (<span class="c-green" data-hide="true">+<?=money($adjustmentIncome)?></span> /
    <span class="c-red" data-hide="true">-<?=money($adjustmentExpense)?></span>) —
